...
class SSP {
	 ...
	 */
	static function simple ( $request, $conn, $table, $primaryKey, $columns,$customFilter )
	{
		$bindings = array();
		$db = self::db( $conn );
	...
	static function mixed ( $request, $conn, $table, $primaryKey, $columns,$customFilter, $newQuery)
	{
		$bindings = array();
		$db = self::db( $conn );
